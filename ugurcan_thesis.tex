...
Setup A &  ~5 *  250m &  10 *  250m &  20 *  250m  \\
Setup B &  1 * 1250m &   1 * 2500m &   1 * 5000m  \\ \hline
\multirow{3}{*}{Setup C} 
 & 10 *  125m & 20 *  125m & 40 *  125m \\
 &  ~~5 *  250m & 10 *  250m & 20 *  250m \\
 &  ~~3 *  500m &  ~~5 *  500m & 10 *  500m \\ \hline
\end{tabular}
\label{secondexp}
\end{table}
...
Between setup A, B and C, resource limits for deployment 2 and instance count for deployment 1 is 
...
For deployment 1 from setup A to B there is a clear decrease in latency. But when instance count
increased again at setup C, performance subtlety worsened. Even thought
the increase in latency was barely noticeable compared to the deployment 2.
...
Results of setups D to G supports the observations from the previous experiments. 
