...
containers' resources.  Until otherwise stated each pod will be constrained to quarter of a CPU core.
...
allow more accuracy and predictable testing durations.
