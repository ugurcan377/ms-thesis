...
NFV. To accomplish this, we implemented a generic service on top of the prevalent container orchestration
software Kubernetes and assessed its performance with numerous clients. Our conclusion is while container
performance varies with different parameters such as resource limits and instance counts, a well adjusted
container setup is compatible to use with virtual network functions excluding some use cases. }
...
performanslarını inceledik. Vardığımız sonuç konteynırlarin performansları kaynak limitleri ve konteynır
sayısı gibi parametrelere göre değişse de iyi ayarlanmış bir konteynır sisteminin belli durumlar dışında
ağ işlevleriyle kullanıma uygun olduğu yönünde oldu.
}
%
% Acknowledgements
...
\begin{figure}
\centering
%\scalebox{.9}{\includegraphics[]{setupd.png}}
