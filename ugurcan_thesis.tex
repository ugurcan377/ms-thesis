...
also develops Kubernetes. Prometheus can easily be installed using the operator model. It can also
receive metrics from other applications via extentions called exporters. To use in the tests we also 
prepared a Docker image with a modified version of Nginx web server to be able send usage metrics to
Prometheus.
